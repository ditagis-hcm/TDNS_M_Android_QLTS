package hcm.ditagis.com.tdns.qlts.async;
...
import hcm.ditagis.com.tdns.qlts.entities.entitiesDB.UserDangNhap;
...
public class NewLoginAsycn extends AsyncTask<String, Void, User> {
    ...
    public NewLoginAsycn(Context context, LoginAsycn.AsyncResponse delegate) {
        ...
        this.API_URL = mContext.getString(R.string.URL_API) + "/AdminAccount/LoginApi";
    }
