package hcm.ditagis.com.tdns.qlts.connectDB;
...
public class ListFeatureLayerDTGDB implements IDB<HashMap<String, String>, Boolean, String> {
    ...
    public List<LayerInfoDTG> find(String account) {
        ...
        try {
            ...
            while (rs.next()) {
                if (rs.getString(mContext.getString(R.string.sql_coloumn_sys_id)).equals(mContext.getString(R.string.GROUP_BASE_MAP)))
